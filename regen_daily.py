...
BASE_DIR = Path("C:/Users/win11/.openclaw/workspace/chlm-website/blog/daily")
...
def mkh(items, count, date_str, date_display):
    ih = ""
    if not items:
        ih = "                <p style='color:#888;text-align:center;padding:2rem;'>今日暂无相关新内容，请稍后再访问。</p>"
    else:
...
<body>
    <header><nav><div class="logo">出海<span>联盟</span></div><ul class="nav-links"><li><a href="/">首页</a></li><li><a href="/about.html">关于我们</a></li><li><a href="/faq.html">常见问题</a></li><li><a href="/resources.html">出海资源</a></li><li><a href="/join.html">加入我们</a></li><li><a href="/blog/">博客</a></li></ul></nav></header>
    <div class="breadcrumb"><a href="/">首页</a> &rsaquo; <a href="/blog/">博客</a> &rsaquo; <a href="/blog/daily/">每日资讯</a> &rsaquo; {date_str}</div>
...
{FOOTER}
    ...
    <footer>
        <div class="footer-content">
            <div class="footer-links"><a href="/">首页</a><a href="/about.html">关于我们</a><a href="/faq.html">常见问题</a><a href="/resources.html">出海资源</a><a href="/join.html">加入我们</a></div>
...
data = [
    ("2026-05-22", "2026年05月22日", 5, items_22),
    ("2026-05-23", "2026年05月23日", 0, []),
    ("2026-05-24", "2026年05月24日", 1, [
        ("@CHGX-供需频道", "序号：包月 类型：需求\n商品：ws拉群\n协议拉群 保开群 不用保时间200-400都可以来聊\n\n联系人：@ADG18418\n交易方式：支持出海担保\n标签：#出海 #WS拉群 #出海联盟 #出海供需 #担保 #供应 #需求"),
    ]),
    ("2026-05-25", "2026年05月25日", 12, items_25),
]

def run():
    for date_str, date_display, count, items in data:
        html = mkh(items, count, date_str, date_display)
        p = BASE_DIR / f"{date_str}.html"
        with open(p, "w", encoding="utf-8") as f:
            f.write(html)
        print(f"[OK] {date_str}.html")
