...
CSS_BASE = """
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @media (max-width: 768px) { .nav-links { display: none; } .article-header h1 { font-size: 1.5rem; } .article-meta { flex-direction: column; gap: 0.5rem; } .footer-channels div { font-size: 0.8rem; } .footer-staff div { font-size: 0.8rem; } }
"""

NAV = """    <header>
        <nav>
            <a href="/#hero" class="nav-logo">
                <img class="nav-logo-icon" src="/public/logo.jpg" alt="CHLM">
